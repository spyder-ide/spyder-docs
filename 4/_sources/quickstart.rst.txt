...
.. raw:: html
   ...
   <div class="interactive-tour-container">
      <img id="tour-default-layout-main" class="tour-screenshot tour-screenshot-active" src="assets/4/tour/tour-default-layout-main.png">
      <img id="tour-options-menu" class="tour-screenshot" src="assets/4/tour/tour-options-menu.png">
      <img id="tour-context-menu" class="tour-screenshot" src="assets/4/tour/tour-context-menu.png">
      <img id="tour-variable-explorer" class="tour-screenshot" src="assets/4/tour/tour-variable-explorer.png">
      <img id="tour-plots" class="tour-screenshot" src="assets/4/tour/tour-plots.png">
      <img id="tour-files" class="tour-screenshot" src="assets/4/tour/tour-files.png">
      <img id="tour-find" class="tour-screenshot" src="assets/4/tour/tour-find.png">
      <img id="tour-profiler" class="tour-screenshot" src="assets/4/tour/tour-profiler.png">
      <img id="tour-code-analysis" class="tour-screenshot" src="assets/4/tour/tour-code-analysis.png">
