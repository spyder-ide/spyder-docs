...
.. dropdown:: Transcript
   ...
   .. div:: scroll
      ...
      To launch Spyder without opening Navigator, open your command line and type ``spyder``. If you followed the :ref:`install-guide`, you should have everything necessary to open Spyder.
